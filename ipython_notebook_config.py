...
# c.NotebookApp.notebook_manager_class = 'IPython.frontend.html.notebook.filenbmanager.FileNotebookManager'
...
# variable IPYTHONDIR.
# c.NotebookApp.ipython_dir = u'/Users/minrk/.ipython'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'/Users/minrk/.ipython'
...
#
# * shell: for request/reply calls to the kernel. * iopub: for the kernel to
# publish results to frontends. * hb: for monitoring the kernel's heartbeat. *
# stdin: for frontends to reply to raw_input calls in the kernel.
#
# The usage of the channels that this class manages is optional. It is entirely
# possible to connect to the kernels directly using ZeroMQ sockets. These
# channels are useful primarily for talking to a kernel whose
# :class:`KernelManager` is in the same process.
#
...
# c.MappingKernelManager.kernel_manager_class = 'IPython.kernel.blockingkernelmanager.BlockingKernelManager'
