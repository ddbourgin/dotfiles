...
"Plugin 'dense-analysis/ale'               " asynchronous code linter
...
if 'VIRTUAL_ENV' in os.environ:
    ...
    set noerrorbells visualbell t_vb=if has('autocmd')
    autocmd GUIEnter * set visualbell t_vb=endif
